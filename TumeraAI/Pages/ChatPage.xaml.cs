...
namespace TumeraAI.Pages
{
    public sealed partial class ChatPage : Page
    {
        ...
        private void ToggleSessionManagerPanelButton_Click(object sender, RoutedEventArgs e)
        {
            if (SessionManagerPanel.Visibility == Visibility.Visible) 
            {
                SessionManagerPanel.Visibility = Visibility.Collapsed;
            }
            else
            {
                SessionManagerPanel.Visibility = Visibility.Visible;
            }
        }

        private void ToggleSessionSettingsPanelButton_Click(object sender, RoutedEventArgs e)
        {
            if (SessionSettingsPanel.Visibility == Visibility.Visible)
            {
                SessionSettingsPanel.Visibility = Visibility.Collapsed;
            }
            else
            {
        ...
        private async void ProviderConnectButton_Click(object sender, RoutedEventArgs e)
        {
            ProviderConnectContentDialog.XamlRoot = MainWindow.GetRootGrid().XamlRoot;
            await ProviderConnectContentDialog.ShowAsync();
        }

        //private void Initialize()
        //{
        //    var quickSendKeyboardAccelerator = new KeyboardAccelerator
        //    {
        //        Key = VirtualKey.Enter,
        //        Modifiers = VirtualKeyModifiers.None
        //    };
        //    quickSendKeyboardAccelerator.Invoked += QuickSendKeyboardAccelerator_Invoked;
        //    PromptTextBox.KeyboardAccelerators.Add(quickSendKeyboardAccelerator);
        //}

        //private void QuickSendKeyboardAccelerator_Invoked(KeyboardAccelerator sender, KeyboardAcceleratorInvokedEventArgs args)
        //{
        //    Inference();
        //    args.Handled = true;
        //}
